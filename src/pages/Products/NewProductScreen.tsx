        ...
        <View style={styles.container}>
            <ScrollView>
                ...
                <View style={[styles.containerItem, {height: 'auto', width: 'auto', borderRadius: 12, marginBottom:15}]}>
                    <View style={[styles.column, {padding:10, width: screenWidth}]}>
                        <TouchableOpacity style={[styles.row, styles.button , {justifyContent: 'space-between', alignItems:'center', alignContent:'center'}]}>
                            ...
                            <TextInput style={[styles.textHint, styles.textInput, {borderBottomWidth:1, borderColor: 'gray', flex: 2}]}>Automation ID</TextInput>
                        </TouchableOpacity>
                        <TouchableOpacity style={[styles.row, styles.button , {justifyContent: 'space-between', alignItems:'center', alignContent:'center'}]}>
                            <Text style={[styles.text, {flex: 1}]}>Name</Text>
                            <TextInput style={[styles.textHint, styles.textInput, {borderBottomWidth:1, borderColor: 'gray', flex: 2}]}>Name of product</TextInput>
                        </TouchableOpacity>
                        <TouchableOpacity style={[styles.row, styles.button , {justifyContent: 'space-between', alignItems:'center', alignContent:'center'}]}>
                            <Text style={[styles.text, {flex: 1}]}>Product Group</Text>
                            <TextInput style={[styles.textHint, styles.textInput, {borderBottomWidth:1, borderColor: 'gray', flex: 2}]}>Product category</TextInput>
                        </TouchableOpacity>
                        <TouchableOpacity style={[styles.row, styles.button , {justifyContent: 'space-between', alignItems:'center', alignContent:'center'}]}>
                            <Text style={[styles.text, {flex: 1}]}>Brand</Text>
                            <TextInput style={[styles.textHint, styles.textInput, {borderBottomWidth:1, borderColor: 'gray', flex: 2}]}>Select a brand</TextInput>
                        </TouchableOpacity>
                        <TouchableOpacity style={[styles.row, styles.button , {justifyContent: 'space-between', alignItems:'center', alignContent:'center'}]}>
                            <Text style={[styles.text, {flex: 1}]}>Selling price</Text>
                            <TextInput style={[styles.textHint, styles.textInput, {borderBottomWidth:1, borderColor: 'gray', flex: 2}]}>0</TextInput>
                        </TouchableOpacity>
                        <TouchableOpacity style={[styles.row, styles.button , {justifyContent: 'space-between', alignItems:'center', alignContent:'center'}]}>
                        ...
                        <TouchableOpacity style={[styles.row, styles.button , {justifyContent: 'space-between', alignItems:'center', alignContent:'center'}]}>
                            ...
                            <TextInput style={[styles.textHint, styles.textInput, {borderBottomWidth:1, borderColor: 'gray', flex: 2}]}>Select located</TextInput>
                        </TouchableOpacity>
                    </View>
                </View>
                ...
                <View style={[styles.containerItem, {height: 'auto', width: 'auto', borderRadius: 12, marginBottom:15}]}>
                    <View style={[styles.column, {padding:10, width: screenWidth}]}>
                        ...
                        <TouchableOpacity style={[styles.row, styles.button , {justifyContent: 'space-between', alignItems:'center', alignContent:'center'}]}>
                            ...
                            <TextInput style={[styles.textHint, styles.textInput, {borderBottomWidth:1, borderColor: 'gray', flex: 2}]}>999999999</TextInput>
                        </TouchableOpacity>
                    </View>
                </View>
                ...
                <View style={[styles.containerItem, {height: 'auto', width: 'auto', borderRadius: 12, marginBottom:15}]}>
                    <View style={[styles.column, {padding:10, width: screenWidth}]}>
                        <TouchableOpacity style={[styles.row, styles.button , {justifyContent: 'space-between', alignItems:'center', alignContent:'center'}]}>
                        <TextInput style={[styles.textHint, styles.textInput, { flex: 1 }]} multiline={true} numberOfLines={4}>Description</TextInput>
                        </TouchableOpacity>
                    </View>
                </View>
                ...
                <View style={[styles.containerItem, {height: 'auto', width: 'auto', borderRadius: 12, marginBottom:15}]}>
                    <View style={[styles.column, {padding:10, width: screenWidth}]}>
                        <TouchableOpacity style={[styles.row, styles.button , {justifyContent: 'space-between', alignItems:'center', alignContent:'center'}]}>
                        <TextInput style={[styles.textHint, styles.textInput, { flex: 1 }]} multiline={true} numberOfLines={4}>Caption</TextInput>
                        </TouchableOpacity>
                    </View>
                </View>
            </ScrollView>
